...
export default function Algorithms() {
  ...
  const validate = (algo, max, windowDur) => {
    if (!['fixed-window', 'sliding-window'].includes(algo)) {
                    ...
                    <div className="grid grid-cols-2 gap-y-3 text-xs">
                      <div>
                        ...
                        <span className="font-semibold text-neutral-800">
                          {policy.algorithm === 'sliding-window' ? 'Sliding Window' : 'Fixed Window'}
                        </span>
                      </div>
                      <div>
                      ...
                      <div>
                        <span className="text-[10px] font-semibold text-neutral-400 uppercase block tracking-wide">Max Requests</span>
                        <span className="font-semibold text-neutral-800">{policy.maxRequests} reqs</span>
                      </div>
                      <div>
                        <span className="text-[10px] font-semibold text-neutral-400 uppercase block tracking-wide">Window Duration</span>
